...
namespace sio
{
    ...
    {
    public:
        typedef boost::function<void (bool,shared_ptr<const string> const&)> encode_callback_function;
        typedef  boost::function<void (packet const&)> decode_callback_function;
