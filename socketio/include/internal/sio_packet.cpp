...
namespace sio
{
    ...
    void packet_manager::set_decode_callback(boost::function<void (packet const&)> const& decode_callback)
    {
        m_decode_callback = decode_callback;
    }

    void packet_manager::set_encode_callback(boost::function<void (bool,shared_ptr<const string> const&)> const& encode_callback)
    {
